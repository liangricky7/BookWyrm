...
<html lang="en">
    ...
    <div class="navBar">
        ...
        <ul>
            <li><a href="/index.html"><img src="../assets/NavBar/Dashboard.png" alt="Dashboard">Dashboard</a></li>
            <li><a href="/pages/books.html"><img src="../assets/NavBar/ManageBooks.png" alt="Manage Books">Manage Books</a></li>
            <li><a href="/pages/patrons.html" class="activePage"><img src="../assets/NavBar/ManagePatrons.png" alt="Manage Patrons">Manage Patrons</a></li>
